...
class PlaygroundMobile {
  ...
  void _export() {
    ...
    var url = "/export";
    var data = {'dart' : '${context.dartSource}', 'html' : '${context.htmlSource}', 'css' : '${context.cssSource}'};
    HttpRequest.postFormData(url, data).then((HttpRequest resp) {
      window.open('/${resp.responseText}', "Export");
    });
  }
